          ...
          <div className="fondo-form lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
            ...
            <div className="w-full px-24 z-10">
              <h1 className="text-4xl font-bold text-left tracking-wide">
                Bienvenido a la plataforma de gestión de tareas.
              </h1>
              <p className="my-4 text-lg">
                Tecnolgías Usadas: React, Tailwind, MongoDb, Node Js y Express
              </p>
              <p className="my-4 text-lg">
                Módulos Usados: react-hook-form, react-router-dom, y otros mas,
                ademas de usar JSON Web Tokens, cookies y desarrollo de una REST
                API.
              </p>
            </div>
          </div>
